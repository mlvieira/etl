...
class TransacaoCreditoDDL(object):

    ddl_stg = '''
        CREATE TABLE IF NOT EXISTS stg.associados_frequentes_credito (
    ...
    '''
    table_name = 'associados_frequentes_credito'

    insert_prd = '''
        INSERT INTO prd.associados_frequentes_credito (
        ...
        where
            ...
            and nom_modalidade = 'CRÉDITO'
    '''

    purge_old_reg = '''
        DELETE FROM prd.associados_frequentes_credito as prd
        WHERE
            dat_transacao < current_date - interval '3' month
    '''